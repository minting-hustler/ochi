    ...
    <div data-scroll data-scroll-section className='relative w-full py-20'>
      ...
      <div className='px-20'>
        <div className='cards w-full flex gap-10 mt-10'>          
          ...
          >
            <h1 className='absolute flex overflow-hidden left-full text-[#CDEA86] -translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-8xl -mb-10 leading-none tracking-tighter'>
          ...
          >
            <div className='card w-full h-full rounded-xl bg-green-600 overflow-hidden'>
              <h1 className='absolute flex overflow-hidden text-[#CDEA86] right-full translate-x-1/2 top-1/2 -translate-y-1/2 z-[9] text-8xl -mb-10 leading-none tracking-tighter'>
